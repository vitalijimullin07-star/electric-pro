...
cd "$(dirname "$0")"
CC=${CC:-clang}
EXPORTS="vac_setup vac_loop vac_tick vac_on_pin vac_serial vac_command vac_status_json sim_buffer"
FLAGS=""
...
$CC --target=wasm32 -O2 -std=c11 -Wall -Wextra -Wno-unused-parameter \
  ...
  -o vacuum-esp32.wasm vac_core.c vac_ui.c vac_drv.c sim_wasm.c
