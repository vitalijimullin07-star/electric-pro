 ...
 * входы АЦП1, левый торец — клапан 1, кнопка «Продувка», зуммер, нижний ряд (к разъёмам) —
 * шины I²C, энкодер, кнопки, детектор нуля. Выводы, которые ПЗУ дёргает при загрузке
...
#define PIN_SDA0 18     /* I²C 0: экран и SDP810-500Pa (перепад на фильтре) */
#define PIN_SCL0 5
