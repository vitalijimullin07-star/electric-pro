...
export const CHIP_SPECS: ChipSpec[] = [
  ...
  { id: 'REG_AP63205_SOT-23-6', base: 'SOT-23-6', name: 'AP63205/AP63203 (SOT-23-6)', description: 'Понижающий преобразователь Diodes AP63205 (5 В) / AP63203 (3,3 В), вход 3,8–32 В, 2 А, 1,1 МГц: FB — к выходу, EN — к входу, BST — 100 нФ на SW, дроссель 4,7–6,8 мкГн', group: REG, category: CAT.PS, refPrefix: 'DA', pins: ['FB', 'EN', 'VIN', 'GND', 'SW', 'BST'], tags: ['ap63205', 'ap63203', 'buck', 'dc-dc'] },
  ...
  { id: 'Q_BT134W_SOT-223', base: 'SOT-223', name: 'BT134W / Z0107 (SOT-223, симистор)', description: 'Маломощный симистор 1 А в SOT-223: BT134W-600, Z0107MN — T1 (MT1), T2 (MT2, и теплоотвод), управляющий электрод. Для клапанов, вентиляторов, ламп до ~200 Вт', group: TR, category: CAT.Q, refPrefix: 'VS', pins: ['T1', 'T2', 'G', 'T2'], tags: ['bt134', 'z0107', 'triac'] },
